  ...
  return (
    <div className="h-screen w-screen bg-transparent flex flex-col">
      <div className="flex-1 flex flex-col bg-zinc-900/90 border border-zinc-800 shadow-2xl overflow-hidden backdrop-blur-md">
        ...
        {/* App List */}
        <div className="divide-y divide-zinc-800/50 flex-1 overflow-y-auto overflow-x-hidden custom-scrollbar">
          {dockApps.length === 0 ? (
              ...
              return (
                ...
                >
                  ...
                  <div
                    ...
                    className="flex items-center gap-1.5 bg-zinc-800/80 px-3 py-1.5 rounded-md border border-zinc-700/50 group-hover:border-zinc-500/50 group-hover:bg-zinc-700/80 transition-all shadow-sm"
                  >
                    <span className="text-zinc-400 text-sm group-hover:text-zinc-300">
                      ⌥
                    </span>
